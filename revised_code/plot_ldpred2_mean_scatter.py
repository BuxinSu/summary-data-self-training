...
def build_mean_table(
    ...
    for trait in sorted(ind_traits):
        rows.append(
            {
                "trait": trait,
                "LDpred2_ind_mean": r_squared_mean(ind_files[trait]),
                f"{sum_label}_mean": r_squared_mean(sum_files[trait]),
            }
        )
...
def plot_mean_scatter(
    ...
    print(f"Saved mean scatter plot for {comparison_label} to: {output_file}")
...
def main() -> None:
    ...
    plot_mean_scatter(
        ...
        comparison_label="LDpred2_ind vs LDpred2_sum",
        sum_label="LDpred2_sum",
        output_file=FIGURES_DIR / "LDpred2_ind_vs_sum_mean_scatter.pdf",
    ...
    plot_mean_scatter(
        ...
        comparison_label="LDpred2_ind vs LDpred2_sum_val_100",
        sum_label="LDpred2_sum_val_100",
        output_file=FIGURES_DIR / "LDpred2_ind_vs_sum_val_100_mean_scatter.pdf",
