...
def build_sampled_mean_table(
    ...
    for trait in sorted(ind_traits):
        ind_mean = sampled_r_squared_mean(ind_files[trait])
        sum_mean = sampled_r_squared_mean(sum_files[trait])
        rows.append(
            {
                "trait": trait,
...
def plot_top_mean_pairs(
    ...
    print(f"\nTop {TOP_N} sample-20 mean pairs for {comparison_label}:")
    print(
    ...
    print(f"Saved sample-20 mean paired bar plot to: {output_file}")
...
def main() -> None:
    ...
    plot_top_mean_pairs(
        ...
        comparison_label="LDpred2_ind vs LDpred2_sum",
        sum_label="LDpred2_sum",
        output_file=FIGURES_DIR / "LDpred2_ind_vs_sum_top10_mean_sample20_paired_barplot.pdf",
    )
    ...
    plot_top_mean_pairs(
        ...
        comparison_label="LDpred2_ind vs LDpred2_sum_val_100",
        sum_label="LDpred2_sum_val_100",
        output_file=FIGURES_DIR / "LDpred2_ind_vs_sum_val_100_top10_mean_sample20_paired_barplot.pdf",
    )
